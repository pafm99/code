...
class NumberTileGameViewController : UIViewController, GameModelProtocol, ADBannerViewDelegate {
  ...
  let boardWidth: CGFloat = 260
  // How much padding to place between the tiles
  let thinPadding: CGFloat = 4
  ...
  func followUp() {
    ...
    if userWon {
      ...
      alertView.title = "Win!"
      alertView.message = "Congratulations, achieved the 2048 tile!"
    ...
    if m.userHasLost() {
      ...
      alertView.message = "Ouch... So close!"
