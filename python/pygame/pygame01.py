...
x = 450-35/2
y = 650
playerImage = pygame.image.load("player.gif")
...
name = ""
enemyNames = {0:"Max",1:"Joe",2:"Greg",3:"Rob"}
...
while finished == False:
    ...
    colorBlue = (0,0,255)#R,G,B
    colorWhite = (255,255,255)#R,G,B
    screen.blit(backgroundImage,(0,0))
    screen.blit(treasureImage,(treasureX,treasureY))
    ...
    for enemyX,enemyY,movingRight in enemies:
        ...
        if collision == True:
            ...
            textLose = font.render("You were killed " +name,True,(255,0,0))
    ...
    #pygame.draw.rect(screen,colorBlue,rectOne)
    pygame.display.flip()
    frame.tick(30)
